...
# 2. Ingenieria de Variables y Procesamiento Temporal
...
## 2.4. Exploracion de datos faltantes 
...
# 2.6. Creacion, Transformacion y adecuacion de variables
...
df.drop(columns=['instant','dteday', 'mnth', 'weekday','casual', 'registered','atemp'], inplace=True)


# Pprint de datos
print("Columnas finales:")
print(df.columns.tolist()[:20])
df.to_csv("../data/day_clean.csv", sep=";",index = False) ## Guardamos las variables listas para empezar a correr los modelos
df
```