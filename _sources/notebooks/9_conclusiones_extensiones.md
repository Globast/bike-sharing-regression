...
Modelos aditivos generalizados (GAM): Mantienen interpretabilidad, pero permiten no linealidades suaves (splines de temperatura, humedad, hora del día). Así se captura zonas de confort térmico, umbrales de precipitación a partir de los cuales la demanda cae abruptamente, etc.
